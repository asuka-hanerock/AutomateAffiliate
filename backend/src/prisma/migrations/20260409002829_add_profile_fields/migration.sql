...
INSERT INTO "new_Account" ("claudeApiKey", "createdAt", "cronSchedule", "ctaEnabled", "displayName", "googleServiceAccountJson", "googleSpreadsheetUrl", "id", "niche", "pronoun", "trademark", "twitterAccessToken", "twitterAccessTokenSecret", "twitterApiKey", "twitterApiSecret", "updatedAt", "userId") SELECT "claudeApiKey", "createdAt", "cronSchedule", "ctaEnabled", "displayName", "googleServiceAccountJson", "googleSpreadsheetUrl", "id", "niche", "pronoun", "trademark", "twitterAccessToken", "twitterAccessTokenSecret", "twitterApiKey", "twitterApiSecret", "updatedAt", "userId" FROM "Account";
DROP TABLE "Account";
