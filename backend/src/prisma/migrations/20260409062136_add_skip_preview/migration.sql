...
INSERT INTO "new_Account" ("bio", "claudeApiKey", "createdAt", "cronSchedule", "ctaEnabled", "displayName", "googleServiceAccountJson", "googleSpreadsheetUrl", "id", "niche", "profileImageUrl", "pronoun", "trademark", "twitterAccessToken", "twitterAccessTokenSecret", "twitterApiKey", "twitterApiSecret", "updatedAt", "userId", "xUsername") SELECT "bio", "claudeApiKey", "createdAt", "cronSchedule", "ctaEnabled", "displayName", "googleServiceAccountJson", "googleSpreadsheetUrl", "id", "niche", "profileImageUrl", "pronoun", "trademark", "twitterAccessToken", "twitterAccessTokenSecret", "twitterApiKey", "twitterApiSecret", "updatedAt", "userId", "xUsername" FROM "Account";
DROP TABLE "Account";
