...
INSERT INTO "new_Account" ("claudeApiKey", "createdAt", "cronSchedule", "ctaEnabled", "id", "niche", "twitterAccessToken", "twitterAccessTokenSecret", "twitterApiKey", "twitterApiSecret", "updatedAt", "userId") SELECT "claudeApiKey", "createdAt", "cronSchedule", "ctaEnabled", "id", "niche", "twitterAccessToken", "twitterAccessTokenSecret", "twitterApiKey", "twitterApiSecret", "updatedAt", "userId" FROM "Account";
DROP TABLE "Account";
